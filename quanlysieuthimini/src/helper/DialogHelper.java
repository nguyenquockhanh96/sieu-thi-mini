...
public class DialogHelper {
    ...
    public static void alert(Component parent, String message) {
        JOptionPane.showMessageDialog(parent, message, "SuperSALES - Quản lý siêu thị mini", JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public static boolean confirm(Component parent, String message) {
        int result = JOptionPane.showConfirmDialog(parent, message,
                "SuperSALES - Quản lý siêu thị mini",
    ...
    public static String prompt(Component parent, String message) {
        return JOptionPane.showInputDialog(parent, message,
                "SuperSALES - Quản lý siêu thị mini", JOptionPane.INFORMATION_MESSAGE);
    }
}
