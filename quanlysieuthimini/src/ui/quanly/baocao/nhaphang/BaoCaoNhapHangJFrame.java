...
public class BaoCaoNhapHangJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_BaoCaoTongHopHangNhap = new javax.swing.JRadioButton();
        lbl_BaoCaoHangNhapTheoNCC = new javax.swing.JRadioButton();
        ...
        btg_LoaiBaoCao.add(lbl_BaoCaoTongHopHangNhap);
        lbl_BaoCaoTongHopHangNhap.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lbl_BaoCaoTongHopHangNhap.setSelected(true);
        lbl_BaoCaoTongHopHangNhap.setText("Báo cáo tổng hợp hàng nhập");
        lbl_BaoCaoTongHopHangNhap.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                lbl_BaoCaoTongHopHangNhapActionPerformed(evt);
            }
        });

        btg_LoaiBaoCao.add(lbl_BaoCaoHangNhapTheoNCC);
        lbl_BaoCaoHangNhapTheoNCC.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lbl_BaoCaoHangNhapTheoNCC.setText("Báo cáo hàng nhập theo nhà cung cấp");
        lbl_BaoCaoHangNhapTheoNCC.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                lbl_BaoCaoHangNhapTheoNCCActionPerformed(evt);
            }
        });
            ...
            .addGroup(pnl_CotTraiLayout.createSequentialGroup()
                .addGroup(pnl_CotTraiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnl_CotTraiLayout.createSequentialGroup()
                        .addGap(14, 14, 14)
                        .addGroup(pnl_CotTraiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lbl_BaoCaoHangNhapTheoNCC)
                            .addComponent(lbl_BaoCaoTongHopHangNhap)))
                    .addGroup(pnl_CotTraiLayout.createSequentialGroup()
                        .addGap(109, 109, 109)
    ...
    private void lbl_BaoCaoHangNhapTheoNCCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lbl_BaoCaoHangNhapTheoNCCActionPerformed
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_lbl_BaoCaoHangNhapTheoNCCActionPerformed

    private void lbl_BaoCaoTongHopHangNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lbl_BaoCaoTongHopHangNhapActionPerformed
        // TODO add your handling code here:
        lbl_TenBaoCao.setText("Báo cáo tổng hợp hàng nhập");
        lbl_TongGiaTri.setVisible(true);
        lbl_TongSoLuong.setVisible(true);
    }//GEN-LAST:event_lbl_BaoCaoTongHopHangNhapActionPerformed
    ...
    private javax.swing.JRadioButton lbl_BaoCaoHangNhapTheoNCC;
    private javax.swing.JRadioButton lbl_BaoCaoTongHopHangNhap;
